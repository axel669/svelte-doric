<script>
    ...
    import {ActionArea, Chip} from "../../core"
        ...
        <demo-area>
            <FlexLayout direction="column">
                ...
                <div style="text-align: center;">
                    <Chip color="primary" label="Los Angeles" clickable>
                    ...
                    <Chip color="primary" label="Denver" clickable />
                    <Chip color="primary" label="Dallas" clickable />
                </div>
            </FlexLayout>
